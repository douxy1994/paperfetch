...
def test_browser_workflow_namespace_reexports_core_helpers() -> None:
    ...
    assert browser_workflow._build_shared_playwright_image_fetcher is fetchers._build_shared_playwright_image_fetcher
...
def test_browser_workflow_namespace_uses_canonical_child_modules() -> None:
    ...
    assert html_extraction.fetch_html_with_direct_playwright is browser_workflow.fetch_html_with_direct_playwright
    assert fetchers._choose_playwright_seed_url is browser_workflow._choose_playwright_seed_url
