...
def server_instructions() -> str:
    return (
        ...
        "`preferred_providers` may include `elsevier`, `springer`, `wiley`, `science`, `pnas`, `ieee`, or `crossref`. "
        ...
        "publishing `ieee_html` or `ieee_pdf` when those routes return usable full text. "
        ...
        "their PDF/ePDF fallback routes remain text-only. Springer and IEEE PDF fallback "
...
def fetch_tool_description() -> str:
    return (
        ...
        "`ieee_html` or `ieee_pdf`. Elsevier PDF "
        ...
        "PDF/ePDF fallback text-only, and Springer/IEEE PDF fallback is also text-only "
        "in this version. Set "
