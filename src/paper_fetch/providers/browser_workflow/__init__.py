...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "SciencePnasHtmlFailure": ("paper_fetch.extraction.html.signals", "SciencePnasHtmlFailure"),
    ...
    "extract_science_pnas_markdown": (".html_extraction", "extract_science_pnas_markdown"),
