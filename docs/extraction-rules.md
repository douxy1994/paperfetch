...
- 它对应的阶段是：`html-cleanup`、`markdown-normalization`。
- Owner：`paper_fetch.providers.html_springer_nature` 与 `paper_fetch.extraction.html._runtime`；`paper_fetch.providers.html_noise` 仅保留 legacy compatibility facade。
- 代表性 HTML / XML：
  - [`../tests/fixtures/block/10.1007_s00382-018-4286-0/raw.html`](../tests/fixtures/block/10.1007_s00382-018-4286-0/raw.html)
...
- Owner：`paper_fetch.providers._mdpi_html` 与 `paper_fetch.models.render`。
- 代表性 HTML：
...
- Owner：`paper_fetch.providers._mdpi_html` 与 `paper_fetch.extraction.html.formula_rules`。
- 代表性 HTML：
