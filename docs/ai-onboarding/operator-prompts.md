...
- 第 7 步 implement-provider：派子 agent，prompt 见 docs/ai-onboarding/operator-prompts.md §C。
...
<<<贴 docs/ai-onboarding/cleaning-chain-proposals/<NAME>.yml 全文；不要贴 .evidence.yml>>>
